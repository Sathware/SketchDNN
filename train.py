...
from gumbel_diffusion_trainer import train_on_multiple_gpus
...
def main():
    ...
    learning_rate = 1e-4
    num_epochs = 300
    experiment_string = "gumbeldiff_ddp_Adam_32crossattnblocks16heads256class256param256edge256time_betadist1,2_more_skip nll,mse loss"
